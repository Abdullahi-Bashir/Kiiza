...
import AboutImage from '../assets/Kiiza.png';
const About = () => {
  return (
    <div className='bg-black text-white py-20 id="about"'>
      <div className='container mx-auto px-8 md:px-16 lg:px-24'>
      <h2 className='text-4xl font-bold text-cenrter mb-12'>About me </h2>
      <div className='flex flex-col md:flex-row items-center md:space-x-12'>
        ...
        <div className='space-y-4'>
          <div className='flex items-center'>
            <label htmlFor='htmlandcss' className='w-2/12'>html & Css
            </label>
          ...
          <div className='flex items-center'>
            <label htmlFor='htmlandcss' className='w-2/12'>React JS 
            </label>
            <div className="grow bg-gray-800 rounded-full h-2.5">
              <div className='bg-gradient-to-r from-green-400 to-blue-500 h-2.5 rounded-full 
          ...
          <div className='flex items-center'>
            <label htmlFor='htmlandcss' className='w-2/12'>Node JS
            </label>
            <div className="grow bg-gray-800 rounded-full h-2.5">
              <div className='bg-gradient-to-r from-green-400 to-blue-500 h-2.5 rounded-full 
        ...
        <div className='mt-12 flex justify-between items-center'>
          <div>
            <h3 className='text-2xl font-bold text-transparent text-center bg-clip-text
          ...
          <div>
            <h3 className='text-2xl font-bold text-transparent text-center bg-clip-text bg-gradient-to-r from-green-400 to-blue-500'>
              10+
            </h3>
            <p>
              Happy Clients
